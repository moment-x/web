...
# 按token推送
def DemoPushToken(msg, token, x=xinge.XingeApp(ACCESS_ID, SECRET_KEY)):
...
if '__main__' == __name__:
    ...
    msg = BuildIOSMsg('gg', {'gg':'gg'})
    DemoPushToken(x, msg, 'd9e24ffbbd8f01c709c7ac1de558436859309276575207bbfd3361f26f687e53')
